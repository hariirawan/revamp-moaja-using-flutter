...
class _CourierTrackState extends State<CourierTrack>
  ...
  Widget build(BuildContext context) {
    double initialSize = _isCollapse ? 0.72 : 0.5;
        ...
        DraggableScrollableSheet(
            ...
            builder: (context, scrollController) {
              return Container(
                ...
                child: Stack(
                  children: [
                    InfoCourier(initalWidthSize: initalWidthSize),
                    AnimatedPositioned(
                        left: 0,
                        top: !_isCollapse ? 185 : 0,
...
class InfoCourier extends StatelessWidget {
  const InfoCourier({
    Key key,
    @required this.initalWidthSize,
  }) : super(key: key);

  final double initalWidthSize;
